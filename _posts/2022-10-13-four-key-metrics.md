...
Since then, I am a huge fan of the practices proclaimed by the book Accelerate by Nicole Forsgren {% cite Forsgren2018 %} and the entire [DevOps Research & Assessment (DORA)](https://www.devops-research.com) program and its outcome, the [State of DevOps Report](https://www.devops-research.com/research.html#reports).
...
The [State of DevOps Report 2021](https://cloud.google.com/devops/state-of-devops) sees Trunk-based Development as one of the core capabilities that drives a higher SDP and organizational performance {% cite Smith2021 %}.
...
I can definitely recommend to really read the book Accelerate {% cite Forsgren2018 %} and the [State of DevOps Reports](https://cloud.google.com/devops/state-of-devops) as well as use the numbers and examples to convince your stakeholders.
